...
?>
    <div class="form-group">
	  ...
	  <form action="?act=cate" method="post">
        ...
        <!--只有超级管理员才可以添加分类-->
        <div class="form-group">
            <button class="btn btn-success form-control" name="op" value="add">新建分类</button>
        </div>
        <?php } ?>
    </form>
        ...
        <ul class="list-unstyled">
            ...
            <li class="menu" id="info_<?php echo $v['aid'];?>">
                ...
                <div style="float:right;margin-right:16px;">
                    ...
                    &nbsp;<button class="btn btn-info btn-xs" name="op" value="edit">修改</button>
                </div>
                <?php } ?>
                <br>
	...
	<form action="?act=api&tag=<?php echo $_GET['tag'];?>&op=add" method="post">
        <?php if(is_supper()){?>
            ...
            <div class="form-group">
                ...
                <button class="btn btn-success form-control">新建接口</button>
            </div>
        <?php } ?>
    </form>
    <div class="list">
        <ul class="list-unstyled" style="padding:5px">
            ...
            <li class="menu" id="api_<?php echo md5($v['id']);?>" >
                <a href="<?php echo U(array('act'=>'api','tag'=>$_GET['tag'])); ?>#info_api_<?php echo md5($v['id']) ?>" id="<?php echo 'menu_'.md5($v['id'])?>">
                   <?php  $v['num']?> <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>
                    <?php echo $v['name'] ?>
                </a>
            </li>
