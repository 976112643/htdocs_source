...
<head>
    ...
    <link href="./MinPHP/res/bootstrap-3.3.4-dist/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <link href="./MinPHP/res/style.css" rel="stylesheet" type="text/css">
	<script src="./MinPHP/res/index.js"></script>	
	<script src="./MinPHP/res/jquery.min.js"></script>
	<script src="./MinPHP/res/bootstrap.js"></script>	
	<script src="./MinPHP/res/bootstrap-modal.js"></script>
