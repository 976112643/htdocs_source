...
var _JS_='/webroot/Public/Home/js';
var _IMG_='/webroot/Public/Home/img';
var _CSS_='/webroot/Public/Home/css';
</script>
<link rel="stylesheet" type="text/css" href="/webroot/Public/Home/css/bootstrap.min.css" />
<link rel="stylesheet" type="text/css" href="/webroot/Public/Home/css/font-awesome.min.css" />
<link rel="stylesheet" type="text/css" href="/webroot/Public/Home/css/font-awesome-ie7.min.css" />
<link rel="stylesheet" type="text/css" href="/webroot/Public/Home/css/iconfont.css" />
<link rel="stylesheet" type="text/css" href="/webroot/Public/Home/css/template-style.css" />
<link rel="stylesheet" type="text/css" href="/webroot/Public/Plugins/artdialog/css/ui-dialog.css" />
<link rel="stylesheet" type="text/css" href="/webroot/Public/Home/css/common.css" />
<script type="text/javascript" src="/webroot/Public/Home/js/jquery.min.js"></script>
<script type="text/javascript" src="/webroot/Public/Home/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/webroot/Public/Plugins/artdialog/js/dialog-min.js"></script>
<script type="text/javascript" src="/webroot/Public/Plugins/Validform_v5.3.2_min.js"></script>
<script type="text/javascript" src="/webroot/Public/Home/js/common.js"></script>
<script type="text/javascript" src="/webroot/Public/Static/js/common.js"></script>
	<!--[if lt IE 9]>
	  <script type="text/javascript" src="/webroot/Public/Home/js/html5shiv.min.js"></script>
	  <script type="text/javascript" src="/webroot/Public/Home/js/respond.min.js"></script>
	<![endif]-->
	<!--[if lte IE 6]>
	<link rel="stylesheet" type="text/css" href="/webroot/Public/Home/css/fix-ie.css" />
	<script type="text/javascript" src="/webroot/Public/Home/js/bootstrap-ie.js"></script>
	<link rel="stylesheet" type="text/css" href="/webroot/Public/Home/css/bootstrap-ie6.min.css" />
	<![endif]-->
...
<div class="search">
	<div class="container p_lr">
		<div class="f_l">
			<div class="f_l">
				<a class="logo" href="<?=U('Home/Index/index')?>" class="ct_nav" style="background-image:url('/webroot/<?=C('SITE_LOGO')?>'); background-size: cover;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/webroot/<?=C('SITE_LOGO')?>',sizingMethod='scale');">N邦翻译</a>
			</div>
			<div class="f_l city" >
...
<div class="nav_ZH">
 ...
 $navigation = getNavigation(); $top_navigation = $navigation['top']; foreach($top_navigation as $row){ ?>
			<?php if($row['title'] == 首页){ ?>
			<li><a href="/webroot<?=$row['url']?>" target='<?=$row['target']?>'><?=$row['title']?></a></li>
			<?php }else{?>
			<li><a href="/webroot/<?=$row['url']?>" target='<?=$row['target']?>'><?=$row['title']?></a></li>
			<?php
 } } ?>
...
<div class="nav_ZH">
 ...
 $navigation = getNavigation(); $top_navigation = $navigation['top']; foreach($top_navigation as $row){ ?>
			<?php if($row['title'] == 首页){ ?>
			<li class="list_nav"><a href="/webroot<?=$row['url']?>" target='<?=$row['target']?>'><?=$row['title']?></a></li>
			<?php }else{?>
			<li class="list_nav"><a href="/webroot/<?=$row['url']?>" target='<?=$row['target']?>'><?=$row['title']?></a></li>
			<?php
 } } ?>
...
var config={
	...
	<script type="text/javascript" src="/webroot/Public/Home/js/superSlide.js"></script>
	<!--第一块-->
	<div class="container p_lr clearfix">
					...
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						...
						<?php  foreach($home_banner as $k=>$row){ ?>
							<div class="item <?php if($k==0){echo 'active';} ?>">
								<img src="/webroot/<?=$row['image']?>" alt="<?=$row['title']?>">
							</div>
						<?php  } ?>
						</div>
						<!-- Controls -->
 ...
 foreach($advert as $k=>$row){ ?>
							<ul class="piclist mainlist">
								<li><a href="<?=completion_url($row['url'])?>" target="_blank" ><img src="/webroot/<?=$row['image']?>" alt="<?=$row['title']?>"></a></li>
							</ul>
							<?php
 } ?>
						</div>
 ...
 foreach($news as $k=>$row){ ?>
							...
							<div class="userpic_ZH clearfix">
								<div class="f_l">
									<div class="pto_box_ZH">
										<img src="/webroot/icon/<?=session('home_member_id')?>_avatar_big.jpg" onerror="this.src='/webroot/Public/Home/img/sc_template/onerror_pic.png'">
									</div>
								</div>
					...
					<div class="right_box_ZH wx_box_ZH clearfix">
						<!-- <img class="f_l" src="/webroot/Public/Home/img/sc_template/wx_pic.jpg" width="90" height="90"> -->
						<img class="f_l" src="/webroot/<?=C('QR_CODE')?>" width="90" height="90">
						<div class="f_r wx_ZH">
	...
	<table class="table">
		<tr>
			<td>
				<img src="/webroot/Public/Home/img/jump_bg_s.png">暂无数据
			</td>
		</tr>
	</table>
</div>
 ...
 foreach($shop_company as $k=>$row){ $length = count($shop_company); ?>
					...
					<a href="<?=U('/Home/Classes/detail',array('shop_id'=>$row['id']))?>">
						<div class="w_204 img_ZH">
							<div class="img_pic" style="background-image: url('/webroot/<?=$row['logo']?>');"></div>
							<!-- <img onerror="this.src='/webroot/Public/Home/img/sc_template/onerror_pic.png'" src="/webroot/<?=$row['logo']?>"> -->	
						</div>
...
<div class="footer_box_ZH">
 ...
 $navigation = getNavigation(); $bottom_navigation = $navigation['bottom']; foreach($bottom_navigation as $key => $row){ ?>
				...
				|
				<?php }?>
			<a href="/webroot/<?=$row['url']?>" target='<?=$row['target']?>'><?=$row['title']?></a>
			<?php
 } ?>
		...
		<ul class="clearfix">
			<li><img src="/webroot/Public/Home/img/sc_template/footer_icon_1.png"></li>
			<li><img src="/webroot/Public/Home/img/sc_template/footer_icon_2.png"></li>
			<li><img src="/webroot/Public/Home/img/sc_template/footer_icon_3.png"></li>
			<li><img src="/webroot/Public/Home/img/sc_template/footer_icon_4.png"></li>
			<li><img src="/webroot/Public/Home/img/sc_template/footer_icon_5.png"></li>
			<li><img src="/webroot/Public/Home/img/sc_template/footer_icon_6.png"></li>
			<li><img src="/webroot/Public/Home/img/sc_template/footer_icon_7.png"></li>
			<li><img src="/webroot/Public/Home/img/sc_template/footer_icon_8.png"></li>
		</ul>
	</div>
</div>
