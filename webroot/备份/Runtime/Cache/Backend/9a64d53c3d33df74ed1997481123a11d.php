                ...
                <div class="box-body">
                  <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                  	<div class="row">
                        ...
                        <div class="col-md-7">
							<form action='<?=U('')?>'>
								<label><input type="search" name='title' class="form-control input-sm" placeholder="请输入标题" aria-controls="example1"></label>
								<label><input type="search" name='from_username' class="form-control input-sm" placeholder="请输发送人" aria-controls="example1"></label>
								<label><input type="search" name='to_username' class="form-control input-sm" placeholder="请输接收人" aria-controls="example1"></label>
								<input type="submit" class="btn btn-primary btn-sm" value='搜索' aria-controls="example1">
							</form>
                        </div>
                        
                        <div class="col-md-5 text-right">
						<a href="<?=U('send_msg')?>" class="btn btn-danger btn-sm  ">发送消息</a>
                        	<?php
						...
						<table id="example2" class="table table-bordered table-hover dataTable text-center" role="grid" aria-describedby="example2_info">
	                  		<thead>
		                      	<tr role="row">
									...
									<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">发送人</th>
		                      		<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">接收人</th>
		                      		...
		                      		<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">发送时间</th><!-- 
		                      		...
		                      		<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width:8%">查看</th>
		                      		<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width:9%">阅读状态</th>
		                    ...
		                    <tbody>
							<?php
 foreach($result as $v){ if($v['status']){ $icon_status='enable'; }else{ $icon_status="disabled"; } ?>
							<tr>
								<td><label><input type="checkbox" class="ids" name="ids[]" value="<?=$v['id']?>"></label></td>
								<td align="left"><?=$v['message_title']?></td>
								<td align="center"><?=$v['from_username']?></td>
								<td align="center"><?=$v['to_username']?></td>
								<td align="center"><?=date('Y-m-d H:i',strtotime($v['message_add_time']))?></td>
								<td align="center"><a href="<?=U('detail',array('ids'=>$v['id'],'status'=>'1'))?>" class="font_ico">查看详情</a>
								</td>
								<td align="center">
								    <a href="<?=U('setStatus',array('pid'=>$pid,'ids'=>$v['id'],'status'=>($v['message_status']+1)%2))?>" class="font_ico <?=$icon_status?> ajax-get">
									    <?=$v['message_status_text']?>
									</a>
								</td>
								<td align="center">
									<a href="<?=U('del',array('status'=>-1,'ids'=>$v['id']))?>" class="btn btn-danger btn-sm ajax-get confirm">删除</a>
								</td>
							</tr>
							<?php  } ?>
							</tbody>
