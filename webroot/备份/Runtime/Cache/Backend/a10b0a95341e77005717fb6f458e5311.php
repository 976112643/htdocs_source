...
<!--  -->
 ...
 break; } } } ?>
							...
							<?= $url;?>
							<?=formaturl(@file_get_contents($url),'http://59.175.146.174/'); ?>
						<!-- 	<iframe width="100%"
							src=""
							height="500px"
							>
