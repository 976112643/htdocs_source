...
<aside class="main-sidebar">
 ...
 if($iframe_src==''){ $iframe_src=U($menu['url']); } } ?>
	...
	<div class="wrapper">
		 <!-- note视图模板--> <!-- Content Wrapper. Contains page content -->
