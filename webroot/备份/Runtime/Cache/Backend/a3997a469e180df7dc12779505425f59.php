...
<aside class="main-sidebar">
							...
							<div class="box">
								...
								<div class="box-body">
									<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
										<div class="row">
												<form action="<?=U('Backend/Contents/Notice/index')?>" method='post' />
													<div class="col-md-8">
														...
														<label><input type="search" class="form-control input-sm" placeholder="标题/描述" aria-controls="example1" name='keywords' value="<?=$keywords?$keywords:''?>"></label>
 ...
 if($row['status']==0){ ?>
																...
																<a url="<?=U('disable',array('status'=>0,'ids'=>$row['id'],'pid'=>I('pid')))?>" class="btn bg-navy btn-sm ajax-get confirm">禁用</a>
																<?php
 } ?>
															</td>
															<td align="center">
