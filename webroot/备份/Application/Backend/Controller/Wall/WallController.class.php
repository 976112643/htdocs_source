<?php
namespace Backend\Controller\Wall;
use Backend\Controller\Base\AdminController;
use Think\Model;

class WallController extends AdminController
{
    ...
    public function add ()
    {
        if (IS_POST) {
            ...
            $rules = array(array('title','require','关键字不能为空'), // 默认情况下用正则进行验证
                    array('title','','关键字' . I('keywords') . '已存在',
                            Model::EXISTS_VALIDATE,'unique',Model::MODEL_BOTH));
            // 默认情况下用正则进行验证
