...
//				console.log(tags);
	...
	// 搜索点击提交
	$(".help_search_bar i").click(function(path){
		$(".help_search_bar").action=path;
		$(".help_search_bar").submit();
	})
	$(".help_search_bar input").focus(function(path){
