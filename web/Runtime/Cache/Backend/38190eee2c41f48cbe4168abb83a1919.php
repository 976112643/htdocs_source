							...
							<div class="box">
								...
								<div class="box-body">
									<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
										<div class="row">
												<!-- <form action="<?=U('Backend/Member/Index/index')?>" method='post' />
													<div class="col-md-8">
														...
														<label><input type="search" class="form-control input-sm" placeholder="关键词" aria-controls="example1" name='keywords' value="<?=$keywords?$keywords:''?>"></label>
														<label><input type="submit" class="btn btn-info" value='搜索' /></label>
													</div>
												</form> -->
 ...
 foreach($result as $row){ ?>
														<tr>
															...
															<td align="center">
																<?php
 if($row['status']==0){ ?>
																<a url="<?=U('enable',array('status'=>1,'ids'=>$row['id']))?>" class="btn btn-success btn-sm ajax-get">启用</a>
																<?php
 }else{ ?>
																<a url="<?=U('disable',array('status'=>0,'ids'=>$row['id']))?>" class="btn bg-navy btn-sm ajax-get">禁用</a>
																<?php
 } ?>
															</td>
															<td align="center">
																<a href="<?=U('edit',array('pid'=>I('pid'),'id'=>$row['id']))?>" class="btn btn-warning btn-sm">修改</a>&nbsp;<a href="<?=U('del',array('status'=>-1,'ids'=>$row['id']))?>" class="btn btn-danger ajax-get confirm">删除</a>
															</td>
														</tr>
														<?php
 } ?>
