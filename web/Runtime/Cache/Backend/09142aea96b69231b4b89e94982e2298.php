          ...
          <div class="box box-primary">
            ...
            <form role="form" action="" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">用户组</label>
			            <select class="select role_id form-control" name="role_id">
    					  	  <option value="0">暂无分组</option>
      						  <?php
