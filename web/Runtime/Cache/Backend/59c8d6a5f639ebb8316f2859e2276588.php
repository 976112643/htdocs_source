...
<aside class="main-sidebar">
						...
						<table id="example2" class="table table-bordered table-hover dataTable text-center" role="grid" aria-describedby="example2_info">
	                  		<thead>
		                      	<tr role="row">
		                      		...
		                      		<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">用户组</th>
		                      		...
		                      		<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">授权</th>
 ...
 foreach($result as $row){ ?>
							<tr>
								...
								<td align="center"><a href="<?=U('access',array('id'=>$row['id']))?>">访问授权</a></td>
								<td align="center">
